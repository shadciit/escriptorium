...
export const retriveCustomTag = async data => (await axios.post(`/documentstags/get_custom_tags/`, data))

export const retriveTagByDocument = async data => (await axios.post(`/documentstags/get_tags/`, data))

export const retriveUnlinkTagByDocument = async data => (await axios.post(`/documentstags/get_unlink_tags/`, data))
...
export const getDocumentsByTags = async data => (await axios.post(`/documents/get_document_by_tags/`, data))
