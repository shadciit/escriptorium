...
from api.serializers import (BlockSerializer, BlockTypeSerializer,
                             DetailedLineSerializer,
                             DocumentMetadataSerializer, DocumentSerializer,
                             DocumentTasksSerializer, LineOrderSerializer,
                             LineSerializer, LineTranscriptionSerializer,
                             LineTypeSerializer, OcrModelSerializer,
                             PartDetailSerializer, PartMoveSerializer,
                             PartSerializer, ProjectSerializer,
                             ScriptSerializer, SegmentSerializer,
                             SegTrainSerializer, TagDocumentSerializer,
                             TrainSerializer, TranscribeSerializer,
                             TranscriptionSerializer, UserOnboardingSerializer)
from core.models import (AlreadyProcessingException, Block, BlockType,
                         Document, DocumentMetadata, DocumentPart, DocumentTag,
                         Line, LineTranscription, LineType, OcrModel, Project,
